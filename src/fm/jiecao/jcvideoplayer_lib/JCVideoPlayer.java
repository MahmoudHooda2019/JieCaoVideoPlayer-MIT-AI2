...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public void init(Context context) {
        ...
        addView(v);
        startButton = (ImageView) findViewWithTag("start");
        fullscreenButton = (ImageView) findViewWithTag("fullscreen");
        progressBar = (SeekBar) findViewWithTag("bottom_seek_progress");
        currentTimeTextView = (TextView) findViewWithTag("current");
        totalTimeTextView = (TextView) findViewWithTag("total");
        bottomContainer = (ViewGroup) findViewWithTag("layout_bottom");
        textureViewContainer = (ViewGroup) findViewWithTag("surface_container");
        topContainer = (ViewGroup) findViewWithTag("layout_top");
    ...
    public void onClick(View v) {
        ...
        } else if (i == "surface_container" && currentState == CURRENT_STATE_ERROR) {
